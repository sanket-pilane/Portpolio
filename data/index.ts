...
export const gridItems = [
  ...
  {
    id: 5,
    title: "Currently building a AI Powered Solutions",
...
export const projects = [
  {
    id: 1,
    title: "Brainwave AI - Mobile and Web App",
    des: "Developed a SaaS-based AI mobile app integrating chat, code generation, image, and video creation using Flutter, OpenAI API, and Replicate models with CI/CD pipelines.",
    img: "/p1.svg",
    iconLists: [
      "/flutter.svg",
      "/openai.svg",
  ...
  {
    id: 2,
    title: "Brainwave Web - Full Stack AI Platform",
    des: "Engineered a full-stack web platform with Next.js and Tailwind CSS, featuring AI tools like text generation, image manipulation, and video synthesis with optimized performance.",
    img: "/branwave-web.png",
    iconLists: [
      "/next.svg",
      "/tail.svg",
      "/ts.svg",
  ...
  {
    id: 3,
    title: "Modern UI/UX Design Website",
  ...
  {
    id: 4,
    title: "ChatGPT Clone - Full Stack Conversational AI",
    des: "Built a full-stack ChatGPT-inspired platform with Node.js backend and Flutter mobile frontend; future plans include web UI in React.js and LLM integration for AI chat features.",
    img: "/chatgpt.png",
    iconLists: [
      "/node.svg",
      "/ts.svg",
  ...
  {
    id: 5,
    title: "Lovely Autos - Luxury Car Flutter App",
  ...
  {
    id: 6,
    title: "Minimal Food - Flutter x Firebase Delivery App",
